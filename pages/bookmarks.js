...
const makeBookmarkListItem =
  (bookmarks, menu, removalAction, reverseRemoval) =>
  ({ index, style }) =>
    (
      <div
        style={style}
        ...
        <div className="bookmark-item-inner">
          ...
          >
            <span
              ...
              style={{
                backgroundImage: `url(${bookmarks[menu][index].thumbnail})`,
              }}
            />
            <h1>
              {menu === "comics"
...
const BookmarksPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Bookmarked comics and characaters from the Marvel collection.
        </title>
      </Head>
